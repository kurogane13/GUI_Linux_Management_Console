...
"""
24) --> Set | Change a user's password
...
while (loop==2):
    ...
    if enter_password != password:
        ...
        image = "redcross.png"
        msg = "No valid password was entered. To retry click Continue, to exit the program Cancel"
        if ccbox(msg, title, image=image):     # show a Continue/Cancel dialog

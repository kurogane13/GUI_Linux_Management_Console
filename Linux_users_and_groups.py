                        ...
                        if remove_user_folder_primary is not None:
                            ...
                            def confirm_reject_removal():
                                ...
                                if confirm_selection == "CONFIRM NOW":
                                    ...
                                    os.system("gnome-terminal -- bash remove_user_folder_primary.sh")
                ...
                if choice == "- DELETE GROUP":
                    def delete_a_group():
                        ...
                        if group_deletion is not None:
                            def confirm_delete_a_group():

                                msg = "ATENTION: Confirmation of GROUP deletion is needed\n\nYou will be deleting the group: "+group_deletion
                                title = "CONFIRM GROUP DELETION"
                                image = "warning.png"
                                choices = ["DELETE GROUP NOW", "Re-enter GROUP to DELETE", "<-- Go back to GROUP Modes", "<-- Back to Main Menu", "EXIT PROGRAM"]
                                confirm_group = buttonbox(msg, title, choices, image=image)
                                if confirm_group == "DELETE GROUP NOW":
                                ...
                                if confirm_group == "Re-enter GROUP to DELETE":
                                    delete_a_group()
                                    
                                if confirm_group == "Go back to GROUP Modes":
                                    group_operations_mode()

                                if confirm_group == "<-- Back to Main Menu":
                                    main_menu()
                        ...
                        if rename_group_var is not None:
                            ...
                            def assign_new_group_name():
                                ...
                                if new_group_name is not None:
                                    ...
                                    rename_group = open('ren_group.sh', 'w')
                                    ...
                                    rename_group.close()
                                    os.system("gnome-terminal -- bash ren_group.sh")
                                    os.system("gnome-terminal -- rm ren_group.sh 2> /dev/null")
                                    group_operations_mode()
